...
python3 -m gtfs_flex_to_gofs_lite --gtfs-dir ./tests/test_ondemand_stops/input  --gofs-lite-dir ./tests/test_ondemand_stops/expected_default --url "" --timestamp 0python3
